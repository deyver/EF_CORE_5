...
function ListarTodos() {
    ...
    $.ajax({ type: "GET", url: "/Empresa/GetAllCompany", dataType: "json" })
        .done(function (data) {
                        ...
                        button.click(function (event) {
                            ...
                            if (IndexGrid != undefined && IndexGrid > -1) {
                                ...
                                if (reg != undefined && reg != null) {
                                    ...
                                    $.ajax({ type: 'GET', url: `/Empresa/Update?registro=${reg.id}`, contentType: 'html', beforeSend: function () { $('.preloader').fadeIn(); } })
...
function Carregar() {
    ...
    $('#botaoCriar').on('click', function () {
        $.ajax({ type: 'GET', url: '/Empresa/Create', contentType: 'html', beforeSend: function () { $('.preloader').fadeIn(); } })
    ...
    //Botao Exportar
    $("#btnExportar").click(function () { $("#jqxGrid").jqxGrid('exportdata', 'xls', 'Empresas', true, null, false); });
}

function Deletar(empresa) {
    
    $.ajax({ type: 'POST', url: '/Empresa/Delete', dataType: 'json', data: { registro: empresa.id } })
        .done(function (data) {
