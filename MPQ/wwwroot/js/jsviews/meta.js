...
function ListarTodos() {
    ...
    $.ajax({ type: "GET", url: "/Meta/GetAllGoal", dataType: "json" })
        .done(function (data) {
                        ...
                        button.click(function (event) {
                            ...
                            if (IndexGrid != undefined && IndexGrid > -1) {
                                ...
                                if (reg != undefined && reg != null) {
                                    ...
                                    $.ajax({ type: 'GET', url: `/Meta/Update?registro=${reg.id}`, contentType: 'html', beforeSend: function () { $('.preloader').fadeIn(); } })
...
function Carregar() {
    ...
    $('#botaoCriar').on('click', function () {
        $.ajax({ type: 'GET', url: '/Meta/Create', contentType: 'html', beforeSend: function () { $('.preloader').fadeIn(); } })
    ...
    //Botao Exportar
    $("#btnExportar").click(function () { $("#jqxGrid").jqxGrid('exportdata', 'xls', 'Metas', true, null, false); });
}

function Deletar(meta) {
    
    $.ajax({ type: 'POST', url: '/Meta/Delete', dataType: 'json', data: { registro: meta.id } })
        .done(function (data) {
